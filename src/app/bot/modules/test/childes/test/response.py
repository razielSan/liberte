# Responses, strings, text for module test.childes.test
...
logging_data = get_loggers(name="test")



inline_data = get_child_modules_settings_inline_data(
    module_path=bot_path.BOT_DIR / "modules" / Path("test/childes/test/childes"),
    root_package="app.bot.modules.test.childes.test.childes",
