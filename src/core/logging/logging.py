...
from core.logging.response import LoggerStorage
...
def setup_bot_logging(
    ...
    info_logger: Logger = getLogger(f"{log_name}_info")
    ...
    warning_logger: Logger = getLogger(f"{log_name}_warning")
